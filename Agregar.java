...
/**
 * La clase Agregar es un JFrame que permite al usuario agregar una nueva cuenta bancaria.
 *
 * @author Grupo
 */
public class Agregar extends javax.swing.JFrame {
    ...
    String idioma;
     ...
     /**
     * Construye un nuevo JFrame Agregar con el carnet, tipo de cuenta e idioma dados.
     *
     * @param carnet El número de identificación del usuario.
     * @param Cuenta El tipo de cuenta que el usuario desea crear.
     * @param idioma El idioma de la aplicación.
     */
    public Agregar(String carnet, String Cuenta, String idioma) {
     ...
     /**
     * Genera un número de cuenta aleatorio de 8 dígitos basado en un número de inicio dado.
     *
     * @param inicio El número de inicio para el número de cuenta.
     */
    ...
    /**
     * Lee los datos personales del usuario desde un archivo.
     */
    ...
    /**
     * Guarda los datos de la nueva cuenta en un archivo.
     */
    private void guardarDatos() {
     ...
     /**
     * Guarda los datos de la nueva cuenta en un archivo separado.
     */
    ...
    /**
     * Guarda el saldo de la nueva cuenta en un archivo.
     */
    ...
    *
    * @param idioma El idioma deseado (por ejemplo, "es" para español, "en" para inglés, etc.).
    */
    ...
    */
    ...
    /**
    * Lee y guarda los datos, luego cierra la ventana actual.
    */
    ...
    /**
    * Maneja el estado del checkbox "Bolivianos".
    */
    ...
    /**
    * Maneja el estado del checkbox "Dolares".
    */
    ...
    /**
    * Maneja el estado del checkbox "Euros".
    */
