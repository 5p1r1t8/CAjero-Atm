...
/**
 * La clase ElegirT es un JFrame que permite al usuario seleccionar el tipo de transferencia que desea realizar.
 * Muestra un título, etiquetas para los tipos de transferencia y botones para seleccionar el tipo de transferencia e idioma.
 * La clase también incluye métodos para cambiar el idioma de la interfaz.
 */
public class ElegirT extends javax.swing.JFrame {
    ...
    String idioma;
     /**
     * Construye un nuevo objeto ElegirT.
     *
     * @param carnet el número de tarjeta del usuario
    ...
    private void btnCPropiasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCPropiasActionPerformed
       ...
       /**
     *  Se accede a cuentas e otros usuarios
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElegirT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
