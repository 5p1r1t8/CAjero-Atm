...
/**
 * Esta clase representa   una pantalla  que tiene  dos opciones
 *  que son 'Iniciar sesion' en caso de que  el usuario tenga una cuenta
 * y 'registrarse' para e usuario que desee tenr una cuenta del banco   deun cajero automacio
 *  @author  Grupo 
 */
...
public class Pantalla1 extends javax.swing.JFrame {
    ...
    String idioma;
     /**
     * Construye un nuevo objeto `Pantalla1` con el idioma especificado.
     *
     * @param idioma el idioma a usar para el texto localizado
     */
   ...
   /**
    * Cambia el idioma dee la interfaz segun elidioma seeleccionado
    * actualizando todos los textos con el idioma correespondiente
    * @param idioma l código de idioma que se desea establecer (por ejemplo, "en", "es", "qu")
    */
